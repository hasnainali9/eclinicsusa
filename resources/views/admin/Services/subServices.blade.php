				...
				<div class="card">
					<div class="card-header d-sm-flex d-block">
						<div class="me-auto mb-sm-0 mb-3">
							<h4 class="card-title mb-2">Sub Services</h4>
						</div>
						<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#addSliderModal" class="btn btn-info">+ Add Sub Service</a>
					</div>
					<div class="card-body">
						<div class="table-responsive">
							<table class="table style-1" id="ListDatatableView">
								...
								<tbody>
									...
									@foreach ($SubServices as $key=>$slider)
                                    <tr role="row" class="odd">
                                            ...
                                            <td>
                                                @if($slider->status)
                                                    <a href="{{route('home.SubServices.status.update',['status'=>base64_encode('In-Active'),'id'=>base64_encode($slider->id)])}}"><span class="badge badge-success">Active</span></a>
                                                @else
                                                <a href="{{route('home.SubServices.status.update',['status'=>base64_encode('Active'),'id'=>base64_encode($slider->id)])}}" ><span class="badge badge-danger">In-Active</span></a>                                                    
                                                @endif
                                            </td>
                                            <td>
                                                <div class="d-flex action-button">
                                                    <a href="javascript:void(0);"  data-id="{{base64_encode($slider->id)}}" data-title="{{$slider->title}}" data-content="{{urldecode($slider->short_description)}}" data-image="{{$slider->image}}" class="btn btn-info btn-xs light px-2 edit_data">
                                                    ...
                                                    <a href="{{route('home.SubServices.delete',['id'=>base64_encode($slider->id)])}}" class="ms-2 btn btn-xs px-2 light btn-danger">
                                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="modal fade " id="addSliderModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{route('home.SubServices.store')}}" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                                @csrf
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Title</label>
                                    <div class="col-sm-9">
                                        <input type="text" required name="title" class="form-control" placeholder="Title of Service">
                                    </div>
                                </div>
                                <div class="mb-3 row">
        ...
        <div class="modal fade" id="editSliderModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{route('home.SubServices.update')}}" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                                @csrf
                                ...
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Title</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="title_edit" required name="title" class="form-control" placeholder="Title of Service">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Content</label>
